...
const {setstoredata,storeinfo,setsample,updatesample, getsampleinfo, storeforuser}=require('../Components/adminpanel');
...
adminRoute.get('/storeinfoforuser',userMiddleware,storeforuser);
